...
import static io.hhp.speciallecture.biz.constants.LectureConstants.USER_ID_HEADER;
...
public class LectureRegController {
    ...
    public ResponseEntity<List<LectureRegResponseDto>> checkIsRegisterForLectureByUserId(
